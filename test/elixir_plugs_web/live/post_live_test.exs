defmodule ElixirPlugsWeb.PostLiveTest do
  use ElixirPlugsWeb.ConnCase

  import Phoenix.LiveViewTest
  import ElixirPlugs.PostsFixtures

  @create_attrs %{body: "some body", text: "some text"}
  @update_attrs %{body: "some updated body", text: "some updated text"}
  @invalid_attrs %{body: nil, text: nil}
